...
export default function License() {
    const element =
        <div className="main-text">
            <p>
                The software used to create and maintain this website
                is licensed under the <a href="http://www.apache.org/licenses/">Apache License 2.0</a>.
            </p>
            <h1>Definitions</h1>
            <p>
            ...
            <h1>Grant of Copyright License</h1>
            <p>
            ...
            <h1>Submission of Contributions</h1>
            <p>
            ...
            <h1>Accepting Warranty or Additional Liability</h1>
            <p>
